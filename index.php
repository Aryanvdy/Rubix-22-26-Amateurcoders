  ...
  <section class="w-s" id="features">
    <div class="container-fluid">
      ...
      <div class="feature-box col-lg-4">
        <a href="videoconsult.html"><i class="fas fa-video fa-3x f-ico"></i></a>
        <h3>Video Consultations</h3>
        <p>So easy to use, even your dog could do it.</p>
      </div>
      <div class="feature-box col-lg-4 ">
        <a href="chatbot.html"><i class="fas fa-robot fa-3x f-ico"></i></a>
        <h3>24/7 Assistance</h3>
        <p>Chatbot support for emergencies.</p>
      </div>
      <div class="feature-box col-lg-4">
        <a href="appointment.html"><i class="fas fa-check fa-3x f-ico"></i></a>
        <h3>Book appointments</h3>
        <p>Find good doctors at your convenient time.</p>
      </div>
      <div class="feature-box col-lg-4">
        <a href="pharmacy.html"><i class ="fas fa-briefcase-medical fa-3x f-ico"></i></a>
        <h3>Med Store</h3>
        <p>Find prescribed medicines at lowest rate.</p>
      </div>
      <div class="feature-box col-lg-4">
        <a href="news.html"><i class="far fa-newspaper fa-3x f-ico"></i></a>
        <h3>Latest news</h3>
        <p>Get all the updates related to health care.</p>
      </div>
      <div class="feature-box col-lg-4">
        <a href="labtest.html"><i class="fas fa-vial fa-3x f-ico"></i></a>
        <h3>Lab test</h3>
        <p></p>
      </div>
